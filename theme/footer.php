			...
			?>
				...
				<footer class='container_wrap socket_color' id='socket' <?php avia_markup_helper(array('context' => 'footer')); ?>>
                    <div class='container'>
                        ...
                        ?>
                        <div class="ard-copy"><p>Продвижение сайта <a href="http://kornyak.ru/" rel="nofollow">kornyak.ru</a>, частный интернет маркетолог в Москве</p></div>
                    </div>
...
<script type='application/ld+json'>{"@context": "www.schema.org","@type": "Organization","@id": "https://itis-time.ru/contacts/","name": "Итс Тайм","url": "https://itis-time.ru","logo": "https://itis-time.ru/wp-content/uploads/2018/03/logo-time.png","image": "https://itis-time.ru/wp-content/uploads/2018/03/logo-time.png","telephone": "+7 495 720 38 70","email": "info@itis-time.ru","address": {"@type": "PostalAddress","streetAddress": "метро Дубровка, улица 2-я, Машиностроения, дом 17, строение 1, офис 102","addressLocality": "г. Москва","postalCode": "115088","addressCountry": "Россия"}}</script>
<script type='application/ld+json'>{"@context": "www.schema.org","@type": "WebSite","name": "Итс Тайм","alternateName": "Итс Тайм","url": "https://itis-time.ru"}</script>
